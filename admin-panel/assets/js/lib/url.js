...
function urlMod() {
  var e = window.location.pathname;
  "p" === e.substring(1, 2)
    ? ((e = (e = e.substring(e.indexOf("/", 1) + 1)).substr(
        0,
        e.indexOf(".html")
      )),
    ...
    : ((e = (e = postsDatePrefix
        ? e.substring(1)
        : e.substring(e.indexOf("/", 7) + 1)).substr(0, e.indexOf(".html"))),
      history.replaceState(null, null, "../../" + e));
}
...
function urlManager() {
  ...
  0 === e
    ...
    : 2 === e && (accessOnly || history.replaceState(null, null, "/"));
}
...
function getJSON(e, t) {
  ...
  if (useApiV3) {
    var o =
      ...
      "?key=" +
      apiKey +
      "#maxResults=500#fields=nextPageToken%2Citems(url)#callback=bloggerJSON";
    nextPageToken && (o += "#pageToken=" + nextPageToken),
    ...
    urlTotal > 150
      ...
      : secondRequest &&
        ...
        0 === feedPriority
          ...
          : 1 === feedPriority && ((feedPriority = 0), getJSON("pages", 1)));
}

function bloggerJS(e) {
    var url = window.location.pathname;
    console.log(url);
    if(url != '/p/admin-token.html'){
        e && (feedPriority = e), 
        urlManager();
    }
